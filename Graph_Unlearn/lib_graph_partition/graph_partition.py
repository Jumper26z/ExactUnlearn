...
from lib_graph_partition.partition_contrastive import PartitionContrastive
...
class GraphPartition:
    ...
    def graph_partition(self):
        ...
        elif self.partition_method == 'contrastive':
            partition_method = PartitionContrastive(self.args, self.graph, self.dataset)
        else:
