...
def parameter_parser():
    ...
    #ligthGCN
    parser.add_argument('--hidden_channels', type=int, default=24)
    parser.add_argument('--num_layers', type=int, default=3)

    # 常用修改参数
    parser.add_argument('--top_k', type=int, default=10)
    parser.add_argument('--exp', type=str, default='unlearning',
                        choices=["partition", "unlearning", "node_edge_unlearning"])
    parser.add_argument('--dataset_name', type=str, default='Movielens1M',
                        choices=["Movielens1M","AmazonBook","Movielens100K"])
    parser.add_argument('--partition_method', type=str, default='sage_km',
                        choices=["sage_km", "random", "lpa", "metis", "lpa_base", "sage_km_base","contrastive"])
    parser.add_argument('--num_shards', type=int, default=9)
    parser.add_argument('--test_ratio', type=float, default=0.1)
    parser.add_argument('--target_model', type=str, default='LightGCN', choices=["LightGCN","NGCF","SGL","SAGE", "GAT", 'MLP', "GCN", "GIN"])
    ...
    parser.add_argument('--ratio_deleted_edges', type=float, default=0.1)
